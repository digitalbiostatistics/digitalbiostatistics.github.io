...
Our projects aim to establish the rigorous methodological foundations of digital biostatistics while demonstrating their practical value in biomedical research, clinical practice, and population health. Our goal is to develop the statistical methods required to transform continuous, longitudinal, and multimodal health data into reliable biomedical knowledge and clinically meaningful decisions. We organize this work around three interconnected research programs.</p>  

<h3>Flagship Research Programs</h3>
We organize this work around three interconnected research programs, with the overarching goal of generating real-world impact in diabetes care and personalized nutrition.
<div class="research-focus-grid" aria-label="Flagship research programs">

  <article class="research-focus-card">
    <h3>Digital Phenotyping and Personalized Health</h3>
    <p>
      How can continuous physiological and multimodal biological data be
      transformed into reproducible digital phenotypes for personalized
      medicine?
    </p>
  </article>

  <article class="research-focus-card">
    <h3>Digital Biomarkers for Disease Progression</h3>
    <p>
      Can near-continuous digital measurements detect clinically meaningful
      changes before conventional clinical assessments?
    </p>
  </article>

  <article class="research-focus-card">
    <h3>Population Health and Digital Epidemiology</h3>
    <p>
      How can digital health data improve population-level surveillance,
...
<div class="question-grid">
  ...
  <article class="question-card">
      ...
      <p>
      How can e-values be developed into a general framework for large-scale multiple-hypothesis testing in high-dimensional digital health studies?
      </p>
  ...
  <article class="question-card">
    ...
    <p>
      What mathematical and statistical foundations are needed to establish distributional data analysis as a rigorous, interpretable, and broadly applicable framework for digital health?
    </p>
