...
The goal of this project is to develop a new generation of statistical models for multimodal digital health and omics data and to apply them to clinically relevant problems, with the potential to generate important new insights into human health.
...
3. Apply these models to fundus imaging data to investigate the genetic, metabolic, and demographic factors associated with the risk of retinopathy.

4. Conduct GWAS analyses to identify novel genetic variants associated with glucose metabolism and digital glycemic phenotypes.

5. Analyse microbiome data to identify microbial factors associated with glucose metabolism, with particular emphasis on glucose dynamics and postprandial responses.
